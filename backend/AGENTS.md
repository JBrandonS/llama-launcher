...
## MODULE SCOPE
Python backend package — CLI interface, config management, model detection, process management, daemon, API server. 15 `.py` modules. No external subdirectories.
...
| `api_server` | module | api_server.py | FastAPI HTTP API server, /models endpoint |
